...
* Kiểm tra kỹ Job Opening: Nếu không chọn Tin tuyển dụng, bạn sẽ không thể chọn được Ứng viên hay Hội đồng phỏng vấn.
* <mark style="color:$primary;">Biến hệ thống: Không xóa các dấu ngoặc nhọn</mark> <mark style="color:$primary;">trong mẫu email vì đây là mã để hệ thống tự lấy dữ liệu từ lịch đã thiết lập.</mark>
* Đồng bộ hóa: Luôn cập nhật hoặc hủy lịch trình trên hệ thống nếu có thay đổi đột xuất để đảm bảo kho ứng viên luôn hiển thị dữ liệu thời gian thực chính xác nhất.
